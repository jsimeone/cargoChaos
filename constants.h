...
namespace constants {
    ...
    const float LASER_NODE_SCALE = 1;
    ...
    const float PLAYER_SPRINT_SPEED = 12;
    const float PLAYER_ENCUMBERED_SPEED = 8;
    ...
    const float MAX_PLACE_OFFSET = 1000;
...
<<<<<<< Updated upstream
=======
    const int MAX_CONVEYOR_CAPACITY = 1000;
    const int FRAMES_PER_SPAWN = 300;
>>>>>>> Stashed changes
